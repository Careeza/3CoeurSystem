...
CS_Scene    *init_scene(SDL_Renderer *render)
{
    ...
    scene->CS_createElementToSceneFromPng("resources/source/FondMenu2.jpg", 100, 100, 0, 0, 0);
    ...
    scene->CS_createButtonToScene(12, 6, 0, 52, 5, &Function6);
    scene->CS_writeTexte(-1, "Play");
    scene->CS_addBorder(-1);

    scene->CS_createButtonToScene(12, 6, 0, 60, 5, &Function5);
    scene->CS_writeTexte(-1, "Hotkeys");
    scene->CS_addBorder(-1);

    scene->CS_createButtonToScene(12, 6, 0, 68, 5, &Function7);
    scene->CS_writeTexte(-1, "Video");
    scene->CS_addBorder(-1);

    scene->CS_createButtonToScene(12, 6, 0, 76, 5, &Function9);
    scene->CS_writeTexte(-1, "Sound");
    scene->CS_addBorder(-1);

    scene->CS_createButtonToScene(12, 6, 0, 84, 5, &Function1);
...
CS_Scene    *init_scene1(SDL_Renderer *render)
{
    ...
    scene->CS_createButtonToScene(30, 12, 35, 44, 5, &Function8);
    scene->CS_writeTexte(-1, "Video");

    scene->CS_createButtonToScene(30, 12, 35, 61, 5, &Function10);
    scene->CS_writeTexte(-1, "Sound");
...
CS_Scene    *init_scene5(SDL_Renderer *render)
{
    ...
    scene->CS_createButtonToSceneFromPng("resources/source/FondJeu2.png", 25, 30, 37.5, 35, 5, &Function3);
    ...
    scene->CS_createButtonToSceneFromPng("resources/source/FondJeu2.png", 25, 30, 67.5, 35, 5, &Function3);
...
CS_Scene    *init_scene6(SDL_Renderer *render)
{
    ...
    scene->CS_createButtonToScene(38, 8, 31, 11, 5, &Function1);
    scene->CS_writeTexte(-1, "Resolution : 1920x1080");

    scene->CS_createButtonToScene(38, 8, 31, 24, 5, &Function1);
    scene->CS_writeTexte(-1, "Window Mode : Windowed");

    scene->CS_createButtonToScene(38, 8, 31, 37, 5, &Function1);
    scene->CS_writeTexte(-1, "Vertical Sync : Disabled");

    scene->CS_createButtonToScene(36, 8, 32, 50, 5, &Function1);
    scene->CS_writeTexte(-1, "Frame Rate : No Limit");

    scene->CS_createButtonToScene(28, 8, 36, 63, 5, &Function1);
...
CS_Scene    *init_scene8(SDL_Renderer *render)
{
    ...
    scene->CS_createButtonToScene(30, 8, 35, 11, 5, &Function1);
    scene->CS_writeTexte(-1, "Master Volume : 100");

    scene->CS_createButtonToScene(30, 8, 35, 24, 5, &Function1);
    scene->CS_writeTexte(-1, "Music Volume : 50");

    scene->CS_createButtonToScene(38, 8, 31, 37, 5, &Function1);
    scene->CS_writeTexte(-1, "Sound Effect Volume : 75");

    scene->CS_createButtonToScene(40, 8, 30, 50, 5, &Function1);
    scene->CS_writeTexte(-1, "Ambient Sound Volume : 75");

    scene->CS_createButtonToScene(30, 8, 35, 63, 5, &Function1);
